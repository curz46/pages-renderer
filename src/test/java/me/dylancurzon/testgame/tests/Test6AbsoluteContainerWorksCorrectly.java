...
public class Test6AbsoluteContainerWorksCorrectly {
    ...
    public static PageTemplate testCMarginContainer() {
        try {
            return new PageTemplate.Builder()
                .setFixedSize(Vector2i.of(1920, 1080))
                .add(new ImmutableAbsoluteContainer.Builder()
    ...
    public static PageTemplate testDMarginElement() {
        try {
            return new PageTemplate.Builder()
                .setFixedSize(Vector2i.of(1920, 1080))
                .add(new ImmutableAbsoluteContainer.Builder()
